                     ...
                     {(formData.paymentMode === 'UPI' || formData.paymentMode === 'Credit Card' || formData.paymentMode === 'Debit Card') && (
                       <div>
                           ...
                           <div className="flex flex-wrap gap-2">
                             {formData.paymentMode === 'UPI' ? (
                               <>
                                 <button
                                   type="button"
                                   onClick={() => setFormData({...formData, bankAccount: 'gpay@okicici'})}
                                 ...
                                 <button
                                   type="button"
                                   onClick={() => setFormData({...formData, bankAccount: 'phonepe@ybl'})}
                                 ...
                                 <button
                                   type="button"
                                   onClick={() => setFormData({...formData, bankAccount: 'paytm@paytm'})}
                                   className="px-2 py-1 text-xs bg-blue-100 text-blue-700 rounded hover:bg-blue-200"
                                 >
                                   Paytm
                                 </button>
                               ...
                               <>
                                 <button
                                   type="button"
                                   onClick={() => setFormData({...formData, bankAccount: 'HDFC - ****'})}
                                 ...
                                 <button
                                   type="button"
                                   onClick={() => setFormData({...formData, bankAccount: 'ICICI - ****'})}
                                 ...
                                 <button
                                   type="button"
                                   onClick={() => setFormData({...formData, bankAccount: 'SBI - ****'})}
                                   className="px-2 py-1 text-xs bg-blue-100 text-blue-700 rounded hover:bg-blue-200"
                                 >
                                   SBI
                                 </button>
                                 <button
                                   type="button"
                                   onClick={() => setFormData({...formData, bankAccount: 'Axis - ****'})}
                         ...
                         <p className="text-xs text-gray-500 mt-1">
                           {formData.paymentMode === 'UPI' 
                             ? 'Format: name@bank (e.g., john@icici)' 
                             : 'Format: Bank Name - Last 4 digits (e.g., HDFC - 1234)'
                           }
                         </p>
                       </div>
                     )}
